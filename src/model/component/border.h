...
class CGlobalBorder : public GlobalComponent
{
public:
    // default value: 32 -> blanks space
    CGlobalBorder(bool visible, int top = 32, int bottom = 32, int left = 32, int right = 32, int corner = 32)
        : GlobalComponent {}, top {top}, bottom {bottom}, left {left}, 
          right {right}, corner {corner} 
    {}
    ~CGlobalBorder() override {}
public:
    bool visible;
